...
C_BOT_COMMANDS = [
                ...
                {"command": "/botinfo", "description": "ᴠɪᴇᴡ ᴄʟᴏɴᴇᴅ ʙᴏᴛ ɪɴғᴏ ᴀɴᴅ ᴀssɪsᴛᴀɴᴛ sᴛᴀᴛᴜs."},
                {"command": "/setchannel", "description": "sᴇᴛ sᴜᴘᴘᴏʀᴛ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴄʟᴏɴᴇ ʙᴏᴛ."},
                {"command": "/setsupport", "description": "sᴇᴛ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ғᴏʀ ᴄʟᴏɴᴇ ʙᴏᴛ."},
                {"command": "/setstring", "description": "sᴀᴠᴇ ᴀssɪsᴛᴀɴᴛ sᴛʀɪɴɢ sᴇssɪᴏɴ ғᴏʀ ᴄʟᴏɴᴇ ʙᴏᴛ."},
                {"command": "/connect", "description": "ᴄᴏɴɴᴇᴄᴛ sᴀᴠᴇᴅ ᴀssɪsᴛᴀɴᴛ ᴛᴏ ᴄʟᴏɴᴇ ʙᴏᴛ."},
                {"command": "/disconnect", "description": "ᴅɪsᴄᴏɴɴᴇᴄᴛ ᴀssɪsᴛᴀɴᴛ ғʀᴏᴍ ᴄʟᴏɴᴇ ʙᴏᴛ."},
                {"command": "/transfer", "description": "ᴛʀᴀɴsғᴇʀ ᴄʟᴏɴᴇ ʙᴏᴛ ᴏᴡɴᴇʀsʜɪᴘ."}
            ]
